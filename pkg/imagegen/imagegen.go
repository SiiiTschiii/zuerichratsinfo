...
var palette = []color.RGBA{
	{0x00, 0x69, 0xC7, 0xFF}, // brand blue (#0069C7)
	{0x1F, 0x4E, 0x79, 0xFF}, // deep slate blue
	{0x2F, 0x6F, 0x73, 0xFF}, // muted teal
	{0x4A, 0x5D, 0x7A, 0xFF}, // muted indigo
	{0x6B, 0x4F, 0x7A, 0xFF}, // muted violet
}
